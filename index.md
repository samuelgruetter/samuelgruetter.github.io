...
- With my colleague [Andres Erbsen](https://andres.systems/), I developed [Bedrock2](https://github.com/mit-plv/bedrock2), **a program logic to formally verify systems code**, based on separation logic and weakest preconditions, and compatible with omnisemantics.
